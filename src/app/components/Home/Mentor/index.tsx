...
const Mentor: React.FC<MentorProps> = ({ teachers = [] }) => {
  ...
  return (
    <section className='bg-deep-slate py-14 scroll-mt-12' id='mentor'>
      <div className='container relative mx-auto px-4'>
        ...
        <Slider {...settings}>
          {teachers.map((item: any, i: number) => {
            ...
            return (
              <div key={i}>
                <div className='m-3 py-14 mt-10 text-center rounded-2xl bg-white shadow-md group transition-all duration-300 hover:shadow-xl'>
                  <div className='relative mb-10'>
                    ...
                    <div className='absolute right-[22%] -bottom-[2%] bg-white rounded-full p-4 shadow-sm'>
                      <Image
